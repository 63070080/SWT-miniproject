...
function PocketTransfer() {
    ...
    const transfer = async () => {
        if (selectOp1 == "Main") {
            ...
            const response = await fetch('http://server:8085/m2p/' + user._id, {
                method: "PUT",
            ...
            const response = await fetch('http://server:8085/p2m/' + user._id, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(send)
            });
            ...
            const response = await fetch('http://server:8085/p2p/' + user._id, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(send)
            });
